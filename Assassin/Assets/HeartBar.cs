...
public class HeartBar : MonoBehaviour {
	...
	void Start () {
		...
		spacingY = -heartGUI.pixelInset.width * 1 * Screen.height/540;
	...
	public void AddHearts(int n){
		for (int i = 0; i < n; i ++) {
			...
			newHeart.GetComponent<GUITexture>().pixelInset = new Rect(x * spacingX + 0.94f*Screen.width, y * spacingY + 0.9f*Screen.height, -spacingX, -spacingY); //size and position of heartbar
